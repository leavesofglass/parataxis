...
const BODY_CLASSES: Record<FontSize, string> = {
  small:  'font-serif text-[0.9rem] leading-[1.35] text-[#111]',
  medium: 'font-serif text-[1.05rem] leading-[1.4] text-[#111]',
  large:  'font-serif text-[1.25rem] leading-[1.45] text-[#111]',
}
