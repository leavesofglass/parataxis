-- =============================================================================
-- 0027 — Add body_html to recommend_poems return type
-- =============================================================================
-- The body_html column added in 0026 needs to flow through the RPC.
-- The function signature changes (new column in RETURNS TABLE), so we drop
-- the existing overload and recreate it. The body is otherwise identical
-- to 0024 — only the RETURNS TABLE clause and the four RETURN QUERY SELECTs
-- are touched (p.body_html appended to each).
-- =============================================================================
